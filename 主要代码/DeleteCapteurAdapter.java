...
public class DeleteCapteurAdapter extends ArrayAdapter<Sensor> {
    ...
    public DeleteCapteurAdapter(Context context, int resource, int textViewId, ArrayList<Sensor> sensors) {
