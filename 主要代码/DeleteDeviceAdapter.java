...
public class DeleteDeviceAdapter extends ArrayAdapter<Device> {
    ...
    public DeleteDeviceAdapter(Context context, int resource, int textViewId, ArrayList<Device> devices) {
